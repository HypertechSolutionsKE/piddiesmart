        ...
        <div class="col-main col-sm-9 col-xs-12 col-sm-push-3">
          ...
          <div class="shop-inner">
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        ...
                        <a href="single_product.html" class="product-item-photo"> <img class="product-image-photo" src="<?php echo base_url();?>assets/images/cosmetic/34.jpg" alt=""></a> </div>
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        ...
                        <a href="single_product.html" class="product-item-photo"> <img class="product-image-photo" src="<?php echo base_url();?>assets/images/cosmetic/35.jpg" alt=""></a> </div>
                      <div class="pro-box-info">
                        <div class="item-info">
                          <div class="info-inner">
                            <div class="item-title"> <h4><a title="Ipsums Dolors Untra" href="single_product.html">Red pants </a></h4> </div>
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        ...
                        <a href="single_product.html" class="product-item-photo"> <img class="product-image-photo" src="<?php echo base_url();?>assets/images/cosmetic/37.jpg" alt=""></a> </div>
                      <div class="pro-box-info">
                        <div class="item-info">
                          <div class="info-inner">
                            <div class="item-title"> <h4><a title="Ipsums Dolors Untra" href="single_product.html">Red pants </a></h4> </div>
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        ...
                        <a href="single_product.html" class="product-item-photo"> <img class="product-image-photo" src="<?php echo base_url();?>assets/images/cosmetic/39.jpg" alt=""></a> </div>
                      <div class="pro-box-info">
                        <div class="item-info">
                          <div class="info-inner">
                            <div class="item-title"> <h4><a title="Ipsums Dolors Untra" href="single_product.html">Red pants </a></h4> </div>
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        ...
                        <a href="single_product.html" class="product-item-photo"> <img class="product-image-photo" src="<?php echo base_url();?>assets/images/cosmetic/40.jpg" alt=""></a> </div>
                      <div class="pro-box-info">
                        <div class="item-info">
                          <div class="info-inner">
                            <div class="item-title"> <h4><a title="Ipsums Dolors Untra" href="single_product.html">Red pants </a></h4> </div>
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        ...
                        <a href="single_product.html" class="product-item-photo"> <img class="product-image-photo" src="<?php echo base_url();?>assets/images/cosmetic/41.jpg" alt=""></a> </div>
                      <div class="pro-box-info">
                        <div class="item-info">
                          <div class="info-inner">
                            <div class="item-title"> <h4><a title="Ipsums Dolors Untra" href="single_product.html">Red pants </a></h4> </div>
                ...
                <!-- b2 -->
                 <li class="item col-lg-4 col-md-4 col-sm-6 col-xs-12">
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        <a href="single_product.html" class="product-item-photo"> <img class="product-image-photo" src="<?php echo base_url();?>assets/images/cosmetic/42.jpg" alt=""></a> </div>
                      <div class="pro-box-info">
                        <div class="item-info">
                          <div class="info-inner">
                            <div class="item-title"> <h4><a title="Ipsums Dolors Untra" href="single_product.html">Red pants </a></h4> </div>
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        ...
                        <a href="single_product.html" class="product-item-photo"> <img class="product-image-photo" src="<?php echo base_url();?>assets/images/cosmetic/38.jpg" alt=""></a> </div>
                      <div class="pro-box-info">
                        <div class="item-info">
                          <div class="info-inner">
                            <div class="item-title"> <h4><a title="Ipsums Dolors Untra" href="single_product.html">Red pants </a></h4> </div>
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        ...
                        <a href="single_product.html" class="product-item-photo"> <img class="product-image-photo" src="<?php echo base_url();?>assets/images/cosmetic/33.jpg" alt=""></a> </div>
                      <div class="pro-box-info">
                        <div class="item-info">
                          <div class="info-inner">
                            <div class="item-title"> <h4><a title="Ipsums Dolors Untra" href="single_product.html">Red pants </a></h4> </div>
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        ...
                        <a href="single_product.html" class="product-item-photo"> <img class="product-image-photo" src="<?php echo base_url();?>assets/images/cosmetic/32.jpg" alt=""></a> </div>
                      <div class="pro-box-info">
                        <div class="item-info">
                          <div class="info-inner">
                            <div class="item-title"> <h4><a title="Ipsums Dolors Untra" href="single_product.html">Red pants </a></h4> </div>
            ...
            <div class="pagination-area ">
              <ul>
                <li><a class="active" href="shop_grid.html#">1</a></li>
                <li><a href="shop_grid.html#">2</a></li>
                <li><a href="shop_grid.html#">3</a></li>
                <li><a href="shop_grid.html#"><i class="fa fa-angle-right"></i></a></li>
              </ul>
            </div>
          </div>
        </div>
        <aside class="sidebar col-sm-3 col-xs-12 col-sm-pull-9">
          ...
          <div class="single-img-add sidebar-add-slider ">
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel"> 
              ...
              <div class="carousel-inner" role="listbox">
                <div class="item active"> <img src="<?php echo base_url();?>assets/images/cosmetic/42.jpg" alt="slide1">
                ...
                <div class="item"> <img src="<?php echo base_url();?>assets/images/cosmetic/36.jpg" alt="slide2">
                  <div class="carousel-caption">
                ...
                <div class="item"> <img src="<?php echo base_url();?>assets/images/cosmetic/39.jpg" alt="slide3">
                  <div class="carousel-caption">
          ...
          <div class="block special-product">
            ...
            <div class="block-content">
              <ul>
                <li class="item">
                  <div class="products-block-left"> <a href="single_product.html" title="Sample Product" class="product-image"><img src="<?php echo base_url();?>assets/images/cosmetic/40.jpg" alt="Sample Product "></a></div>
                  <div class="products-block-right">
                    <p class="product-name"> <a href="single_product.html">Red Lipstick</a> </p>
                    <span class="price">Kes 500.00</span>
                    <div class="rating"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </div>
                  </div>
                </li>
                <li class="item">
                  <div class="products-block-left"> <a href="single_product.html" title="Sample Product" class="product-image"><img src="<?php echo base_url();?>assets/images/cosmetic/35.jpg" alt="Sample Product "></a></div>
                  <div class="products-block-right">
                    <p class="product-name"> <a href="single_product.html">Blue Nail Polish</a> </p>
                    <span class="price">Kes 4000.00</span>
                    <div class="rating"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> <i class="fa fa-star-o"></i> </div>
                  </div>
                </li>
                <li class="item">
                  <div class="products-block-left"> <a href="single_product.html" title="Sample Product" class="product-image"><img src="<?php echo base_url();?>assets/images/cosmetic/37.jpg" alt="Sample Product "></a></div>
                  <div class="products-block-right">
                    <p class="product-name"> <a href="single_product.html">Brown Pod</a> </p>
                    <span class="price">Kes 4000.00</span>
                    <div class="rating"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </div>
                  </div>
                </li>
