        ...
        <div class="container">
          <div class="row" >
            ...
            <div class="headerlinkmenu col-lg-8 col-md-7 col-sm-12 col-xs-12">
              <div class="links">
                <div class="myaccount"><a title="My Account" href="https://www.facebook.com/piddiesmartclothing/"><i class="fa fa-facebook fontwhite"></i><span class="hidden-xs fontwhite">Facebook</span></a></div>
