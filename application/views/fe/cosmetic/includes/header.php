        ...
        <div class="container">
          <div class="row" >
            <div class="col-lg-4 col-sm-4 hidden-xs"> 
              ...
              <div class="welcome-msg fontwhite">Welcome to PiddieSmart Cosmetics</div>
            </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-4 col-md-3 col-xs-4"> 
            <!-- Header Logo -->
            <div class="logo"><a title="e-commerce" href="index.html"><img alt="e-commerce" src="<?php echo base_url();?>assets/images/cosmetic/30.png" width="70"></a> </div>
            <!-- End Header Logo --> 
          </div>
