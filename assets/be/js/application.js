...
================================================== */
	...
	$('.bar-success').sparkline(
		'html', {type: 'bar', barColor: '#008C46', height: '35px', barWidth: "5px", barSpacing: "2px", zeroAxis: "false"}
	);
	...
	$('#reportrange .date-range').html(moment().format('<i>D</i> <b><i>MMM</i> <i>YYYY</i></b>'));
	...
	moment().subtract('days', 29).format('<i>D</i> <b><i>MMM</i> <i>YYYY</i></b>') + '<em> - </em>' + 
