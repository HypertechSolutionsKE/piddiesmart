        ...
        <div class="page-content">
            ...
            <!-- /page header -->
                ...
                <?php foreach ($property as $row2): ?>
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <form class="validate" method="post" role="form" id="frm_newpropertystart" name="frm_newpropertystart" onsubmit="return update_agent_property_start();" enctype="multipart/form-data">
                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <ul class="nav nav-pills nav-justified">
                                            <li class="active"><a href="<?php echo base_url();?>be/properties/edit_agent_start/<?php echo $row2->property_id; ?>">Step 1: Basic Info</a></li>
                                        ...
                                        <!--<div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-5">
                                                    <small>Please choose at least the region and the city of your property.</small>
                                                </div>
                                            </div>
                                        </div>-->
                                        <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    ...
                                                    <select data-placeholder="Select City/Town..." class="clear-results" tabindex="2" id="city_id" name="city_id">
                                                        ...
                                                        <?php foreach($cities as $row): ?>
                                                            <option value="<?php echo $row->city_id; ?>" <?php if($row2->city_id == $row->city_id){echo 'selected';}  ?>><?php echo $row->city_name; ?></option>
                                                        <?php endforeach; ?>                       
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-7">
                                                    ...
                                                    <input type="number" id="price" name="price" class="form-control" value="<?php echo $row2->price;  ?>"> 
                                                </div>
                                                <div class="col-sm-5">
