    ...
    $.ownage.Loader = function(el, params, selector, number) {
        ...
        base.setStyle = function() {
            ...
            switch (base.params.style) {
                case 4:
                    text = "<img src='" + base.params.image + "' id='" + base.loaderSel + "' style='box-shadow:0px 0px 0px #000;position:absolute;padding:" + base.params.imagePadding + "px;background:" + base.params.imageBgColor + "' alt='Loading...' />";
                    break;
                case 3:
                    text = "<img src='" + base.params.image + "' id='" + base.loaderSel + "' style='box-shadow:0px 0px 0px #222;border-radius:1000px;position:absolute;padding:" + base.params.imagePadding + "px;background:" + base.params.imageBgColor + "' alt='Loading...' />";
                    break;
                case 2:
                ...
                case 1:
                default:
                    text = "<img src='" + base.params.image + "' id='" + base.loaderSel + "' style='box-shadow:0px 0px #000;border-radius:1000px;position:absolute;padding:" + base.params.imagePadding + "px;background:" + base.params.imageBgColor + "' alt='Loading...' />";
                    break;
            }
            return text;
        };
                ...
                case "door":
                    ...
                    if (show) {
                        ...
                        $('#' + myid).css({
                            ...
                            height: '0px',
                            marginTop: '0px',
                            'box-shadow': '0px 0px 0px ' + myData.backgroundColor,
