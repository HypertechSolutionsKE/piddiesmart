        ...
        <aside class="sidebar col-sm-3 col-xs-12 col-sm-pull-9">
          ...
          <div class="block sidebar-cart">
            ...
            <div class="block-content">
              ...
              <ul>
                <li class="item"> <a href="shopping_cart.html" title="Sample Product" class="product-image"><img src="<?php echo base_url();?>assets/images/cosmetic/34.jpg" alt="Sample Product "></a>
                ...
                <li class="item last"> <a href="shop_grid.html#" title="Sample Product" class="product-image"><img src="<?php echo base_url();?>assets/images/cosmetic/32.jpg" alt="Sample Product"></a>
                  <div class="product-details">
                    <div class="access"> <a href="shop_grid.html#" title="Remove This Item" class="remove-cart"><i class="icon-close"></i></a></div>
          ...
          <div class="single-img-add sidebar-add-slider ">
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel"> 
              ...
              <div class="carousel-inner" role="listbox">
                <div class="item active"> <img src="<?php echo base_url();?>assets/images/cosmetic/40.jpg" alt="slide1">
                ...
                <div class="item"> <img src="<?php echo base_url();?>assets/images/cosmetic/41.jpg" alt="slide2">
                  <div class="carousel-caption">
                ...
                <div class="item"> <img src="<?php echo base_url();?>assets/images/cosmetic/40.jpg" alt="slide3">
                  <div class="carousel-caption">
